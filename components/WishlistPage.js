...
const WISHLIST_THEME_VARIANTS = {
  Pastel: {
    ...WISHLIST_THEMES.Light,
    screen: '#F8F5FF',
    card: '#FFFFFF',
    accent: '#8B5CF6',
    accentSoft: '#EDE9FE',
...
Object.assign(WISHLIST_THEMES, WISHLIST_THEME_VARIANTS);
    ...
    () =>
      StyleSheet.create({
        ...
        sectionCard: {
          ...
          shadowOpacity: (theme === 'Dark' || theme === 'Ocean') ? 0.2 : 0.1,
          shadowRadius: 18,
          elevation: 6,
        },
        sectionTitle: {
